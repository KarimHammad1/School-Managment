...
Route::group(
    ...
    Route::get('/classes/{id}',[\App\Http\Controllers\Sections\SectionController::class,'getclasses']);
    ...
    Route::get('/Get_classrooms/{id}',[\App\Http\Controllers\Students\StudentController::class,'Get_classrooms']);
    Route::get('/Get_Sections/{id}',[\App\Http\Controllers\Students\StudentController::class,'Get_Sections']);
